...
export default {
  data() {
    return {
      url: require("../assets/images/404.jpg"),
      window: {
        width: 0,
        height: 0
      },
...
.gobtn {
  margin-top: 5%;
  font-size: 1.5vmax;
  color: rgb(241, 23, 109);
  border: 1px solid rgb(241, 23, 109);
  padding: 3%;
  border-radius: 30px;
  width: 40%;
  margin-left: 3%;
...
.gobtn:hover {
  ...
  font-size: 1.5vmax;
  color: #ffffff;
  background-color: rgb(241, 23, 109);
  border: 1px solid rgb(241, 23, 109);
  padding: 3%;
  border-radius: 30px;
  width: 40%;
...
.open {
  font-size: 10vmax;
  font-family: "neontubes";
  color: rgb(255, 200, 238);
  text-shadow: 0 0 0 transparent, 0 0 10px rgb(241, 23, 109),
    /*0 5px 10px rgba(scale-color($clr1, $lightness: -80%),1),*/ 0 0 20px
      rgba(241, 23, 109, 0.5),
    0 0 40px rgba(241, 23, 109, 1), 0 0 100px rgba(241, 23, 109, 1),
    0 0 200px rgba(241, 23, 109, 1), 0 0 300px rgba(241, 23, 109, 1),
    0 0 500px rgba(241, 23, 109, 1), 0 0 1000px rgba(241, 23, 109, 1);
...
.hrs {
  ...
  text-shadow: 0 0 0 transparent,
    /*0 5px 10px rgba(scale-color($clr2, $lightness: -80%),1),*/ 0 0 10px
      rgb(5, 211, 250),
    0 0 20px rgba(5, 211, 250, 0.5), 0 0 40px rgba(5, 211, 250, 1),
    0 0 100px rgba(5, 211, 250, 1), 0 0 200px rgba(5, 211, 250, 1),
    0 0 300px rgba(5, 211, 250, 1), 0 0 500px rgba(5, 211, 250, 1);
...
.gotoback {
  ...
  color: #ffffff;
  text-shadow: 0 0 0 transparent,
    /*0 5px 10px rgba(scale-color($clr2, $lightness: -80%),1),*/ 0 0 10px#ffffff,
    0 0 20px rgba(250, 250, 250, 0.5), 0 0 40px rgba(250, 250, 250, 1),
    0 0 100px rgba(250, 250, 250, 1), 0 0 200px rgba(250, 250, 250, 1),
    0 0 300px rgba(250, 250, 250, 1), 0 0 500px rgba(250, 250, 250, 1);
  animation: buzz 0.01s infinite alternate;
}
