            ...
            <div id="comment-set">
                <div id="comment-title">
                    ...
                    <div style="display: inline;">
                        ...
                        <button class="boardrecipe-button3" @click="submitComment" type="submit">
                            댓글
                        </button>
                    </div>
                </div>
                                ...
                                export default {
                                                ...
                                                this
                                                    ...
                                                    .then(() => {
                                                        ...
                                                        for (let index = 0; index < 5; index++) {
                                                            if (Number(min + index) > this.$store.state.totalPages) 
                                                                break;
                                                        ...
                                                        this
                                                            .$store
                                                            .dispatch(Constant.GET_LIKEBYBOARDRECIPE, {rid: this.$route.params.rid})
                                                            .then(() => {
                                                                this
                                                                    .$store
                                                                    .dispatch(Constant.GET_LIKEBYUSERANDBOARDRECIPE, {
                                                                        rid: this.rid,
                                    ...
                                    methods: {
                                        ...
                                        submitComment() {
                                            this
                                                .$store
                                                .dispatch(Constant.ADD_REPLYBOARDRECIPE, {
                                                    rid: this.rid,
                                                    username: this.$store.state.username,
                                        ...
                                        deleteComment(i, cmid) {
                                            ...
                                            this
                                                .$store
                                                .dispatch(Constant.REMOVE_REPLYBOARDRECIPE, {
                                                    cmid: cmid,
                                                    rid: this.rid
                                                });
                                        },
